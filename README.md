...
disappear into proprietary chat histories. MirrorMind captures your AI
...
mirrormind init ~/ai-vault
git -C ~/ai-vault init

# 2. Import your AI conversation exports (format auto-detected)
mirrormind import ~/Downloads/claude-export/conversations.json --vault ~/ai-vault
mirrormind import ~/Downloads/chatgpt-export/conversations.json --vault ~/ai-vault

# 3. Inspect
mirrormind status --vault ~/ai-vault
```
...
- `.mirrormind/chunks/*.jsonl` — embedding-ready chunks for RAG tooling.
